<?php
	...
	if(isset($_POST['formData']) && DISPLAY) { //Verify that the data passed to this program contains the expected Array
		...
		die("System Administrator has disabled this service temporarily. Please contact SYSOP at ext. 351 for more information.");
	}
?>